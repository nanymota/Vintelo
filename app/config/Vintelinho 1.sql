...
CREATE TABLE PRODUTOS (
    ...
    ID_ADM_CURADORIA INT NULL,
    STATUS_CURADORIA ENUM ('P', 'a', 'r') DEFAULT 'p',
    MOTIVO_REJEICAO TEXT,
    SCORE_IA DECIMAL(3, 2),
    QUANTIDADE_ESTOQUE INT DEFAULT 1,
    OUTROS TEXT,
    DATA_CADASTRO DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (ID_USUARIO) REFERENCES USUARIOS(ID_USUARIO),
    CONSTRAINT FK_ADM_CATEGORIA FOREIGN KEY (ID_ADM_CURADORIA) REFERENCES ADMINISTRADORES(ID_ADM)
);
...
CREATE TABLE LOG_CURADORIA (
ID_LOG INT PRIMARY KEY AUTO_INCREMENT,
ID_PRODUTO INT NOT NULL,
ID_ADM INT NULL,
TIPO_ACAO ENUM('IA', 'ADM') NOT NULL,
